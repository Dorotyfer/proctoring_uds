...
La captura de referencia se cifra con AES-256-GCM antes de salir hacia el almacenamiento de objetos. PostgreSQL conserva únicamente metadatos, claves de objeto, IV, etiqueta de autenticación, vencimiento y auditoría. La evidencia se entrega mediante una URL de API de 60 segundos que descifra el objeto autorizado en memoria; el bucket nunca es público.
