...
usage() {
  echo "Usage: $0 --source PATH --env FILE --manifest FILE --models-source PATH" >&2
  exit 2
}
...
"$release_path/venv/bin/pip" install --disable-pip-version-check "$release_path/apps/api[vision]"
